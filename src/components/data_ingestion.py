...
class DataIngestion:
    ...
    def export_data_into_feature_store_file__path(self) -> pd.DataFrame:
    ...
    def initiate_data_ingestion(self) -> Path:
        ...
        try:
            feature_store_file_path = self.export_data_into_feature_store_file__path()

            logging.info("got the data from mongoDb")

            logging.info("exited intiate_data_ingestion method of data ingestion class")
